...
mixin _$OrderState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<CartProductIds> products,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<CartProductIds> products, List<Delivery> deliveries,
...
abstract class $OrderStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<CartProductIds> products});
}
...
class _$InitOrderState implements InitOrderState {
  const _$InitOrderState({required final List<CartProductIds> products})
      : _products = products;
...
abstract class InitOrderState implements OrderState {
  const factory InitOrderState({required final List<CartProductIds> products}) =
      _$InitOrderState;

...
CartAdd _$CartAddFromJson(Map<String, dynamic> json) {
  return _CartAdd.fromJson(json);
}
...
mixin _$CartAdd {
  ...
  @JsonKey(ignore: true)
  $CartAddCopyWith<CartAdd> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CartAddCopyWith<$Res> {
  factory $CartAddCopyWith(CartAdd value, $Res Function(CartAdd) then) =
      _$CartAddCopyWithImpl<$Res, CartAdd>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CartAddCopyWithImpl<$Res, $Val extends CartAdd>
    implements $CartAddCopyWith<$Res> {
  _$CartAddCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_CartAddCopyWith<$Res> implements $CartAddCopyWith<$Res> {
...
class __$$_CartAddCopyWithImpl<$Res>
    extends _$CartAddCopyWithImpl<$Res, _$_CartAdd>
...
class _$_CartAdd implements _CartAdd {
  ...
  factory _$_CartAdd.fromJson(Map<String, dynamic> json) =>
      _$$_CartAddFromJson(json);
  ...
  @override
  String toString() {
    return 'CartAdd(productId: $productId, cityFias: $cityFias)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, productId, cityFias);
  ...
  Map<String, dynamic> toJson() {
    return _$$_CartAddToJson(
      this,
    );
  }
}

abstract class _CartAdd implements CartAdd {
  const factory _CartAdd(
      {@JsonKey(name: 'product_id') required final int productId,
      @JsonKey(name: 'city_fias', includeIfNull: false)
      final String? cityFias}) = _$_CartAdd;

  factory _CartAdd.fromJson(Map<String, dynamic> json) = _$_CartAdd.fromJson;
